...
if (typeof globalThis.navigator === "undefined")
	globalThis.navigator = { userAgent: "node", platform: "node", language: "en", clipboard: {} };
if (typeof globalThis.Element === "undefined")
	globalThis.Element = class { get prototype() { return {}; } };
if (typeof globalThis.HTMLElement === "undefined") globalThis.HTMLElement = class {};
if (typeof globalThis.SVGElement === "undefined") globalThis.SVGElement = class {};
if (typeof globalThis.HTMLCanvasElement === "undefined") globalThis.HTMLCanvasElement = class {};
if (typeof globalThis.CanvasRenderingContext2D === "undefined") globalThis.CanvasRenderingContext2D = class {};
...
if (typeof globalThis.cancelAnimationFrame === "undefined") globalThis.cancelAnimationFrame = clearTimeout;
if (typeof globalThis.devicePixelRatio === "undefined") globalThis.devicePixelRatio = 1;
if (typeof globalThis.fetch === "undefined") globalThis.fetch = () => Promise.resolve({ ok: true, json: () => Promise.resolve({}) });
if (typeof globalThis.Worker === "undefined") globalThis.Worker = class { postMessage() {} terminate() {} addEventListener() {} };
if (typeof globalThis.Blob === "undefined") globalThis.Blob = class {};
if (typeof globalThis.FileReader === "undefined") globalThis.FileReader = class { readAsDataURL() {} addEventListener() {} };
if (typeof globalThis.ClipboardItem === "undefined") globalThis.ClipboardItem = class {};
...
async function main() {
	...
	if (!Array.isArray(skeletons)) {
		console.error("Error: the input module must `export default` an array of skeleton elements.");
		process.exit(1);
	}
